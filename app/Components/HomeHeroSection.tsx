        ...
        <div className="relative flex flex-1 items-center justify-center py-16 md:py-24">
          <div className="mx-auto flex max-w-6xl flex-col items-center text-center">
            <div className="relative mb-10 w-full">
              <div className="absolute inset-0 rounded-[2.5rem] bg-white/60 blur-2xl" />
              <div className="relative mx-auto h-[320px] w-full max-w-4xl overflow-hidden rounded-[2.5rem] border border-white/70 bg-[#ececf1] shadow-2xl md:h-[420px]">
                <Image
                  src="/fotoportada.png"
                  alt="Foto de Carolina Rodriguez"
                  fill
